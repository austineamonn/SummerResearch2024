...
class Data:
    ...
    def first_name(self):
        ...
        with open('SummerResearch2024/datafiles_for_data_construction/first_names.json', 'r') as f:
    ...
    def last_name(self):
        # Reading from a JSON file
        with open('SummerResearch2024/datafiles_for_data_construction/last_names.json', 'r') as f:
    ...
    def major(self):
        # Reading from a JSON file
        with open('SummerResearch2024/datafiles_for_data_construction/majors.csv', 'r') as f:
    ...
    def course(self):
        # Reading from a JSON file
        with open('SummerResearch2024/datafiles_for_data_construction/courses.json', 'r') as f:
    ...
    def subjects(self):
        subjects =  {
            ...
            'subjects_to_careers': {
                ...
                "Literature": ["Writer and Author", "Editor, New Analyst, Reporter, and Correspondent"],
                ...
                "Comparative World Literature": ["Writer and Author", "Editor, New Analyst, Reporter, and Correspondent"],
                ...
                "English": ["Writer and Author", "Editor, New Analyst, Reporter, and Correspondent"],
                ...
                "Portuguese": [],
                "Quechua": [],
                "Rehabilitation Education": ["Rehabilitation Counselor"],
                "Religious Studies": ["Clergy"],
                "Recreation, Sport, and Tourism": ["Recreation and Fitne Worker"],
                "Russian": [],
                "Scandinavian": [],
                "Spanish": [],
                ...
                "World Literatures": ["Writer and Author", "Editor, New Analyst, Reporter, and Correspondent"],
                "Yiddish": [],
                "Zulu": []
            }
        }
    ...
    def careers(self):
        careers = {
            ...
            'careers_to_subjects': {
                ...
                'Athlete, Coache, Umpire, and Related Worker': [],
                ...
                'Drafter': [],
                'Editor, New Analyst, Reporter, and Correspondent': ['Literature', 'Comparative World Literature', 'English', 'World Literatures'],
                ...
                'Recreation and Fitne Worker': ['Recreation, Sport, and Tourism'],
            ...
            'careers_to_future_topics': {
                ...
                'Athlete, Coache, Umpire, and Related Worker': ['Kinesiology', 'Sports Science'],
                ...
                'Drafter': [],
                'Editor, New Analyst, Reporter, and Correspondent': ['Comparative World Literature', 'Journalism', 'English'],
                ...
                'Physician Assistant': ['Medicine'],
                'Police Officer and Detective': [],
                'Postsecondary Teacher': ['Education', 'Educational Psychology', 'Various academic fields'],
                'Power Plant Operator, Distributor, and Dispatcher': [],
