    ...
    def subjects(self):
        subjects =  {
            'subjects_list': [
                ...
                "Yiddish", "Zulu", 'Social Work', 'Computer Engineering', 'Liberal Arts and Sciences', 'Humanities', 'Graphic Design', 'Architecture', 'Public Health', 'Theatre', 'Nursing', 'Speech and Hearing Science', 'Earth Sciences', 'Religion', 'International Relations', 'Public Administration', 'Plant Biology', 'Geography', 'Art History', 'Military Science', 'Recreation, Sport and Tourism', 'Fine Arts'
            ],
    ...
    def future_topics(self):
        topics = {
            'future_topics': [
                ...
                'Public Relations', 'Legal Studies', 'Child Development', 'Military Studies'
            ]
        }
