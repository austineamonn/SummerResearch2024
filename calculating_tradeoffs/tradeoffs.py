...
if __name__ == "__main__":
    ...
    for privatization_type in privatization_types:
        ...
        for RNN_model in RNN_model_list:
            ...
            #Note to self, calculate the Xu separately and concatenate them onto everyone
            #Email them to ask if my work fits in any category and if so which one. abstracts@bmes.org