...
"""
Script to get the tradeoff values from each model. Will run the model, make the graphics, calculate the feature importance, and save it all to the outputs folder.
"""

def get_tradeoffs_ISLogisticRegression(output_path=None):
    # Get output path
    if output_path == None:
...
get_tradeoffs_ISLogisticRegression()